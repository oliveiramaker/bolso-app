...
import { deleteAllData } from "@/database/finance";
...
export default function Settings(){
 ...
 <View style={s.card}><Text style={s.cardTitle}>Backup</Text><Text style={s.muted}>Exporte seus dados em JSON para guardar uma cópia.</Text><Pressable style={s.primary} onPress={backup} disabled={busy}><Text style={s.primaryText}>{busy?"Gerando…":"Exportar backup"}</Text></Pressable></View>
