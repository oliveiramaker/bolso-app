...
export default function Home(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.container}>
   <View style={s.head}><View><Text style={s.brand}>Bolso</Text><Text style={s.muted}>Suas finanças, no controle.</Text></View><Pressable onPress={()=>router.push("/settings")}><Text style={s.settings}>⚙</Text></Pressable></View>
